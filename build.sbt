...
lazy val tasksSlurm = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "io.github.pityka" %% "tasks-core" % "0.0.29",
...
lazy val pipelineExecutor = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "io.github.pityka" %% "tasks-core" % "0.0.29",
      "io.github.pityka" %% "tasks-collection" % "0.0.29",
      "io.github.pityka" %% "tasks-ui-backend" % "0.0.29",
      "io.github.pityka" %% "tasks-tracker" % "0.0.29",
